"""
Data Engineering Functions for Stage 2.

These functions are from Section 2 Notebook 2 and demonstrate
the core data engineering techniques:
1. Data Cleaning - Remove noise fields
2. Data Transformation - JSON → natural text
3. Data Optimization - Token compression
...
def format_courses_for_llm(courses: list[Course], use_compact: bool = False) -> str:
    """
    ...
    for i, course in enumerate(courses, 1):
        if use_compact:
            course_text = compact_course_text(course)
        else:
