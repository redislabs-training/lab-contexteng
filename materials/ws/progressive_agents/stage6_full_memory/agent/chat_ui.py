...
def build_chat_ui(send_callback: Callable[[str], Awaitable[str | dict]]):
    ...
    Args:
        send_callback: Async function that takes a query string and returns
                      ...
                      - cached: (optional) Whether response was cached
                      - used_memory: (optional) Whether memory was used
        ...
        try:
            ...
            if isinstance(response, dict):
                ...
                if response.get("used_memory"):
                    status_parts.append("Memory used")
    ...
    chat_history.append_stdout(
        ...
        "I have working memory for conversation continuity.\n\n"
    )
