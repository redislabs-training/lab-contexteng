...
const contentEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/docs/index.mdx": () => import('./index_a6twojZt.mjs'),"/src/content/docs/intro-ws/getting-started.mdx": () => import('./getting-started_TtMo7g5u.mjs'),"/src/content/docs/intro-ws/welcome.mdx": () => import('./welcome_DP8578fK.mjs'),"/src/content/docs/intro/getting-started.mdx": () => import('./getting-started_BDh2rTGX.mjs'),"/src/content/docs/intro/welcome.mdx": () => import('./welcome_CRpTLbo2.mjs'),"/src/content/docs/wrap-up-ws/finish-lab.mdx": () => import('./finish-lab_DD7sAbih.mjs'),"/src/content/docs/wrap-up/finish-lab.mdx": () => import('./finish-lab_B4TdArs9.mjs')});
...
let lookupMap = {};
lookupMap = {"docs":{"type":"content","entries":{"intro/getting-started":"/src/content/docs/intro/getting-started.mdx","index":"/src/content/docs/index.mdx","intro-ws/getting-started":"/src/content/docs/intro-ws/getting-started.mdx","intro/welcome":"/src/content/docs/intro/welcome.mdx","intro-ws/welcome":"/src/content/docs/intro-ws/welcome.mdx","wrap-up-ws/finish-lab":"/src/content/docs/wrap-up-ws/finish-lab.mdx","wrap-up/finish-lab":"/src/content/docs/wrap-up/finish-lab.mdx"}}};
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/docs/index.mdx": () => import('./index_xeezG1gC.mjs'),"/src/content/docs/intro-ws/getting-started.mdx": () => import('./getting-started_xSBgmGgp.mjs'),"/src/content/docs/intro-ws/welcome.mdx": () => import('./welcome_wY3_w8ji.mjs'),"/src/content/docs/intro/getting-started.mdx": () => import('./getting-started_BJuDtDW4.mjs'),"/src/content/docs/intro/welcome.mdx": () => import('./welcome_CIKzqz5Z.mjs'),"/src/content/docs/wrap-up-ws/finish-lab.mdx": () => import('./finish-lab_WBmFn5Uu.mjs'),"/src/content/docs/wrap-up/finish-lab.mdx": () => import('./finish-lab_f8q_rSPF.mjs')});
...
const starlightConfig = {"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"title":{"en":"LLM Connection Test"},"isMultilingual":false,"defaultLocale":{"label":"English","lang":"en","dir":"ltr"}};
