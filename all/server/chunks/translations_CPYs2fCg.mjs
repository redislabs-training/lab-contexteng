...
import { i as isCoreRemotePath, V as VALID_INPUT_FORMATS, A as AstroError, U as UnknownContentCollectionError, g as AstroUserError } from './astro/assets-service_CHbtoEez.mjs';
import { c as createComponent, h as renderUniqueStylesheet, i as renderScriptElement, j as createHeadAndContent, b as renderComponent, r as renderTemplate, u as unescapeHTML } from './astro/server_DKLinKq0.mjs';
import 'kleur/colors';
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/docs/index.mdx": () => import('./index_ipEf4KtT.mjs'),"/src/content/docs/intro-ws/getting-started.mdx": () => import('./getting-started_BJgvM663.mjs'),"/src/content/docs/intro-ws/welcome.mdx": () => import('./welcome_D8zrdow0.mjs'),"/src/content/docs/intro/getting-started.mdx": () => import('./getting-started_BZp2SSPY.mjs'),"/src/content/docs/intro/welcome.mdx": () => import('./welcome_C0biyuYc.mjs'),"/src/content/docs/wrap-up-ws/finish-lab.mdx": () => import('./finish-lab_C11nG5jm.mjs'),"/src/content/docs/wrap-up/finish-lab.mdx": () => import('./finish-lab_DrviW4Wc.mjs')});
...
let lookupMap = {};
lookupMap = {"docs":{"type":"content","entries":{"index":"/src/content/docs/index.mdx","wrap-up/finish-lab":"/src/content/docs/wrap-up/finish-lab.mdx","intro-ws/getting-started":"/src/content/docs/intro-ws/getting-started.mdx","intro-ws/welcome":"/src/content/docs/intro-ws/welcome.mdx","intro/getting-started":"/src/content/docs/intro/getting-started.mdx","intro/welcome":"/src/content/docs/intro/welcome.mdx","wrap-up-ws/finish-lab":"/src/content/docs/wrap-up-ws/finish-lab.mdx"}}};
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/docs/index.mdx": () => import('./index_CIpSFMAj.mjs'),"/src/content/docs/intro-ws/getting-started.mdx": () => import('./getting-started_BGd9_Pgx.mjs'),"/src/content/docs/intro-ws/welcome.mdx": () => import('./welcome_DyKxh1rf.mjs'),"/src/content/docs/intro/getting-started.mdx": () => import('./getting-started_BRl52bhi.mjs'),"/src/content/docs/intro/welcome.mdx": () => import('./welcome_DMzN7xLw.mjs'),"/src/content/docs/wrap-up-ws/finish-lab.mdx": () => import('./finish-lab_oCbcy-zq.mjs'),"/src/content/docs/wrap-up/finish-lab.mdx": () => import('./finish-lab_BZhB_0iY.mjs')});
...
const starlightConfig = {"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"Introduction","translations":{},"collapsed":false,"items":[{"translations":{},"slug":"intro/welcome","attrs":{}},{"translations":{},"slug":"intro/getting-started","attrs":{}}]},{"label":"Wrap up","translations":{},"collapsed":false,"items":[{"translations":{},"slug":"wrap-up/finish-lab","attrs":{}}]}],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"title":{"en":"Context Engineering with Redis & LangChain"},"isMultilingual":false,"defaultLocale":{"label":"English","lang":"en","dir":"ltr"}};
