...
let lookupMap = {};
lookupMap = {"docs":{"type":"content","entries":{"index":"/src/content/docs/index.mdx","intro/getting-started":"/src/content/docs/intro/getting-started.mdx","intro/welcome":"/src/content/docs/intro/welcome.mdx","intro-ws/getting-started":"/src/content/docs/intro-ws/getting-started.mdx","intro-ws/welcome":"/src/content/docs/intro-ws/welcome.mdx","wrap-up-ws/finish-lab":"/src/content/docs/wrap-up-ws/finish-lab.mdx","wrap-up/finish-lab":"/src/content/docs/wrap-up/finish-lab.mdx"}}};
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/docs/index.mdx": () => import('./index_CIpSFMAj.mjs'),"/src/content/docs/intro-ws/getting-started.mdx": () => import('./getting-started_Cq9dAjS0.mjs'),"/src/content/docs/intro-ws/welcome.mdx": () => import('./welcome_DyKxh1rf.mjs'),"/src/content/docs/intro/getting-started.mdx": () => import('./getting-started_BiAK-Bbz.mjs'),"/src/content/docs/intro/welcome.mdx": () => import('./welcome_DMzN7xLw.mjs'),"/src/content/docs/wrap-up-ws/finish-lab.mdx": () => import('./finish-lab_DBnEJzJB.mjs'),"/src/content/docs/wrap-up/finish-lab.mdx": () => import('./finish-lab_wlhgZ5MH.mjs')});
...
const starlightConfig = {"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"Introduction","translations":{},"collapsed":false,"items":[{"translations":{},"slug":"intro-ws/welcome","attrs":{}},{"translations":{},"slug":"intro-ws/getting-started","attrs":{}}]},{"label":"Wrap up","translations":{},"collapsed":false,"items":[{"translations":{},"slug":"wrap-up-ws/finish-lab","attrs":{}}]}],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"title":{"en":"Redis Workshop: Context Engineering"},"isMultilingual":false,"defaultLocale":{"label":"English","lang":"en","dir":"ltr"}};
