"""
Test exact match with Stage 6 Full Memory agent (ReAct).
"""
...
async def test_cs002():
    ...
    print("\n" + "=" * 80)
    print("STAGE 6 TEST: Exact Match for CS002")
    print("=" * 80)
...
async def test_cs001():
    ...
    print("\n" + "=" * 80)
    print("STAGE 6 TEST: Exact Match for CS001")
    print("=" * 80)
...
async def main():
    ...
    print("\n" + "=" * 80)
    print("STAGE 6 EXACT MATCH TESTS COMPLETE")
    print("=" * 80)
